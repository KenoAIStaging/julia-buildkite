...
rem Exec codesign.sh directly via its shebang rather than through a hardcoded
rem /bin/bash (which Wine resolves as Z:\bin\bash and need not be the bash on
rem this rootfs).
start /wait /unix "%CODESIGN_SH%" %1
